...
The Agent Deliberation Protocol (ADP) was originated by **David H. Friedel Jr.** of **MarketAlly** in 2026 as part of the ai-manifests protocol family ([adp-manifest.dev](https://adp-manifest.dev)). The specification text is released under the [Community Specification License 1.0](LICENSE.md) (Patent and Copyright). The companion specifications — [ADJ](https://github.com/ai-manifests/adj-manifest-spec) (journal) and [ACB](https://github.com/ai-manifests/acb-manifest-spec) (cognitive budget) — share the same origin and licensing model.
